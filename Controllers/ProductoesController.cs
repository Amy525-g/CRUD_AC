...
namespace CRUD_AC.Controllers
{
    public class ProductoesController : Controller
    {
        private readonly CRUD_ACContext _context;

        public ProductoesController(CRUD_ACContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Producto != null ? 
                          ...
                          Problem("Entity set 'CRUD_ACContext.Producto'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CRUD_ACContext.Producto'  is null.");
            }
            var producto = await _context.Producto.FindAsync(id);
            if (producto != null)
            {
